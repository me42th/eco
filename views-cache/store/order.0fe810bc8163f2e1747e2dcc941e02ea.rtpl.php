    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/eco/img/logo.png" alt="Logo" width="70px">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>Sheep Store</strong><br>
                Rua Nagé, 22 - Nordeste de Amaralina<br>
                Salvador - BA<br>
                Telefone: (71) 0000-0000<br>
                E-mail: contato@cabra.io
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars( $value1['product']['desproduct'], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php echo htmlspecialchars( $value1['product']['idproduct'], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tr>
                    <th>Total:</th>
                    <td>R$<?php echo formatPrice($order["vltotal"]+$order["vlfreight"]); ?></td>
                </tr>
                </tbody></table>
            </div>
            </div>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <button type="button" onclick="window.location.href = '/eco/index.php/admin/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status'" class="btn btn-default pull-left" style="margin-left: 5px;">
                    <i class="fa fa-pencil"></i> Editar Status
                </button>
                <button type="button" onclick="window.open('/eco/index.php/boleto/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')" class="btn btn-default pull-left" style="margin-left: 5px;">
