		...
		<div class="row">
			<div class="col-md-12">
				<div class="product-content-right">
					<form action="/eco/index.php/checkout" class="checkout" method="post" name="checkout">
								...
								<div class="col-md-12">				
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="<?php echo htmlspecialchars( $address["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="00000-000" id="billing_address_1" name="deszipcode" id="deszipcode" class="input-text ">
                                            <input type="submit" value="Atualizar CEP" id="place_order" class="button alt" formaction="" formmethod="get">
										</p>
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
											...
											<table class="shop_table">
												...
												<tbody>
													...
													<tr class="cart_item">
														<td class="product-name">
															...
															<?php echo htmlspecialchars( $value1["product"] ["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <strong class="product-quantity">x <?php echo htmlspecialchars( $value1["qnt"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> 
														</td>
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<td><span class="amount">R$ <?php echo formatPrice($amount); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">$<?php echo formatPrice($cart['vlfreight'] + $amount); ?></span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<div id="payment">
