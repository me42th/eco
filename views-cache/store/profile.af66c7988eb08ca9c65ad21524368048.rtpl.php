    ...
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-9">
                ...
                <?php } ?>                
                <form method="post" action="/eco/index.php/perfil">
                    ...
                    <div class="form-group">
                            <label for="nrphone">Login</label>
                            <input type="tel" class="form-control" id="deslogin" name="deslogin" placeholder="Digite o telefone aqui" value="<?php echo htmlspecialchars( $user["deslogin"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="nrphone">Criado em <?php echo create_user_date(); ?></label>
                    </div>
