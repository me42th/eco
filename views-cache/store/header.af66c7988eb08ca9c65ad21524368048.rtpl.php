...
<html lang="pt-br">
  <head>
    ...
    <title>Sheep Store</title>

    <link rel="icon" href="/eco/img/favicon.ico" type="image/x-icon">
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/eco/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/eco/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/eco/css/owl.carousel.css">
    <link rel="stylesheet" href="/eco/css/style.css">
    <link rel="stylesheet" href="/eco/css/responsive.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#" ><img width="90px" src="/eco/img/logo.png"></a></h1>
                    </div>
                </div>
